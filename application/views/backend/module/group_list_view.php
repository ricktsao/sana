<form action="" id="update_form" method="post" class="contentForm">
    	...
    	<div id="option_bar">
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><button type="button" class='btn add' onclick="jUrl('<?php echo $url['edit']?>')"><?php echo $this -> lang -> line("common_insert"); ?></td>
              </tr>
            </table>
        </div>
        <div class="list">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id='dataTable'>
              ...
              <tr class="<?php echo $i%2==0?"odd":"even"?>">
                ...
                <td><button type="button" class='btn edit' onclick="self.location.href='<?php echo $url['edit']."/".$list[$i]["sn"] ?>'" > <?php echo $this -> lang -> line("common_handle"); ?> </button>
</td>              
