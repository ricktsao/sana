...
<form action="<? echo bUrl("updateGallery")?>" method="post"  id="update_form" enctype="multipart/form-data" class="contentEditForm">
	<div id="option_bar">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td >
					<button type="button" class='btn back' onclick="jUrl('<?php echo bUrl("galleryList")?>')"><?php echo $this->lang->line('common_return'); ?></button>
				</td>
			</tr>
		</table>
	</div>
	<table width="100%" border="0" cellspacing="0" cellpadding="0" id='dataTable'>
		...
		<tr>
			<td class="left"><span class="require">* </span>作品集： </td>
			<td>
				<?php echo $cat_info['title']; ?>				
				<input type="hidden" name="gallery_category_sn" value="<?php echo $cat_info["sn"]; ?>" />
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" class='center'>
				<button type="button" class='btn back' onclick="jUrl('<?php echo bUrl("galleryList")?>')"><?php echo $this->lang->line('common_cancel'); ?></button>        	
