<form action="" id="update_form" method="post" class="contentForm">   
    	<div id="option_bar">
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
            	<td>
            		<button type="button" class="btn add" onclick="jUrl('<?php echo bUrl("editFaq")?>')"><?php echo $this->lang->line("common_insert");?></button>	
        		</td>
              </tr>
            </table>
        </div>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id='dataTable'>
     		...
     		<tbody>
              ...
              <tr class="<?php echo $i%2==0?"odd":"even"?>">
                ...
                <td>
                	<button type="button" class="btn edit" onclick="jUrl('<?php echo bUrl("editFaq".'/'.$list[$i]["sn"])?>')"><?php echo $this->lang->line("common_handle");?></button>
              ...
              <tr>
                ...
                <td>                	
                	<button type="button" class="btn del" onclick="listViewAction('#update_form','<?php echo bUrl("delFaq")?>','是否確定刪除')"><?php echo $this->lang->line("common_delete");?></button>
