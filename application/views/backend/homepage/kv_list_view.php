<script language="javascript" type="text/javascript">
	 function Delete() 
    {
        ...
        {
        	var query_string = '<?php echo  getBackendUrl("deleteKv")?>';	
	...
	function Launch() 
    {
        	var query_string = '<?php echo  getBackendUrl("launchKv")?>';	
	        document.getElementById( "update_form" ).action = query_string;	
	        document.getElementById( "update_form" ).submit();     
    }
</script>
    ...
    <div class="contentForm">
    	<div class="option_bar">
        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><input value="<?php echo $this->lang->line("common_insert");?>" type="button" class="btn" onclick="location.href='<?php echo  getBackendUrl('editKv')?>'"/></td>
              </tr>
            </table>
        </div>
        <div class="list">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
              <tr>
                ...
                <th><?php echo $this->lang->line('field_kv_img');?></th>
                <th width="150"><?php echo $this->lang->line("common_sort");?></th>  
              ...
              <tr class="<?php echo $i%2==0?"odd":"even"?>">
                ...
                <td>
                	<img style="max-width:350px" src="<? echo base_url()."upload/website/banner/".$list[$i]["filename"];?>"  /><br />
                	<?php //echo '檔名:'.basename($list[$i]["filename"]);?>
                </td>
                <td><?php echo $list[$i]["sort"]?></td>
                <td><input type="button" class="btn" value="<?php echo $this->lang->line("common_handle");?>" onclick="location.href='<?php echo getBackendUrl('editKv/'.$list[$i]["sn"])?>'" /></td>   
                <td>
