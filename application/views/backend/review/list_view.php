        ...
        <div class='list'>
            <table width="100%" border="0" cellspacing="0" cellpadding="0" >
				...
				?>
					...
					<td><?php echo $datas['sn'];?>.</td>
					<td style='text-align: left;'><?php echo $datas['title'];?></td>
					<td><?php echo $datas['sort'];?></td>
                	<td><?php echo showEffectiveDate($datas["start_date"], $datas["end_date"], $datas["forever"]) ?> </td>
					...
					<td>
						...
						if( $datas["launch"] == 1 )
						{
   							echo form_checkbox('launch[]', $datas['sn'], TRUE, $js);
							echo form_hidden('launch_org[]', $datas["sn"]);
						}
						else
						{
   							echo form_checkbox('launch[]', $datas['sn'], FALSE, $js);
   						}
   						?>
					</td>
					<td>
