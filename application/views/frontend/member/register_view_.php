<script>
	...
	$(function(){
		...
		<div id='primary'>
			<div id='breadCrumb'>
				<span id='home_icon'></span> / <span>註冊會員</span>
			</div>
			<div id='title'>
				<span></span>申請會員填寫資料
			</div>
			...
			*/
            ...
            <tr>
                ...
                <td class="register_sercond"><input name="email" maxlength="100" size="50" value="<?php echo tryGetArrayValue('email',$edit_data); ?>"><?php echo form_error('email');?></td>
			</tr>
            <tr>
            ...
            <tr>
                ...
                <td class="register_sercond"><input name="name" maxlength="50" value="<?php echo tryGetArrayValue( 'name',$edit_data); ?>"><?php echo form_error('name');?></td>
			</tr>
            <tr>
			<td class="register_first"><span>*</span>性別</td>
			<td class="register_sercond"><?php echo formArraySet(array(1=>'男',0=>'女'),'sex','radio',tryGetArrayValue('sex',$edit_data)); echo form_error('sex');?></td>
			</tr><tr>
			...
			<td class="register_sercond">
                ...
                <label><input name="source" value="888" type="radio">網站</label><input name="source_web" maxlength="50" size="15" value="<?php echo tryGetArrayValue('source_web',$edit_data); ?>">
                <label><input name="source" value="999" type="radio">其他</label><input name="source_other" maxlength="50" size="15" value="<?php echo tryGetArrayValue('source_other',$edit_data); ?>">
			</td>
			</tr><tr>
			...
			<td class="register_sercond">
				...
				{
					$sport_method_str = implode(',',tryGetArrayValue('sport_method',$edit_data));
				}
											 
				echo formArraySet($sport_method,'sport_method[]','checkbox',$sport_method_str);
				?>
			</td>
			</tr><tr>
			...
			<tr>
				<td colspan="2" class="register_sercond" align="center"">
					當您在下面按下「確認」按鈕時，則表示您已閱讀並同意<br />
					<a href="<?php echo getFrontendControllerUrl("activity", 'index/3');?>" target="_blank">SOLE會員使用聲明條款</a>與<a href="<?php echo getFrontendControllerUrl("activity", 'index/4');?>" target="_blank">購物說明</a>。
				</td>
			</tr>
			<tr>
				<td class="register_button" colspan="2"><input value="確 認" type="submit" class="btn"/><input value="取 消" type="reset" class="btn_glay"/></td>
			</tr>
