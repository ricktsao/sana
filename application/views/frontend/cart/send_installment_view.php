...
<INPUT TYPE="HIDDEN" name="e03" value="<?php echo $payment_installment;?>">
<INPUT TYPE="HIDDEN" NAME="storeid" SIZE=9 value="<?php echo $payment_bankcode;?>">
...
<INPUT TYPE="HIDDEN" NAME="orderdesc" SIZE=20 value="test">
