<script>
	$(function(){
		...
		<div id='primary'>
			...
			<div id='step'></div>
			<div id='tip'> 謝謝您的訂購您的訂購，你的訂單已經成立。訂單編號為：<?php echo $order_id;?> </div>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				...
				<tr id='second' class='bg'>
					<td colspan="6" class='alignRight'>購物車內合計有<span class='red'><?php echo count($products);?></span> 項商品，商品總金額<span class='gray'>NT <?php echo format_currency($subtotal);?></span>元</td>
				</tr>
				<tr class='bg '>
			...
			<a href='<?php echo getFrontendControllerUrl('cart', 'quest/'.$order_id); ?>' id='quest_btn'>敬邀您填寫健康諮詢問卷，SOLE關心您</a>
