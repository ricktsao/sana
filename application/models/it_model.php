...
class IT_Model extends CI_Model
{
	...
	*/
	...
	開發者：IT Team
	*/
	function listData( $str_table_name , $str_conditions = NULL , $rows = NULL , $page = NULL , $arr_sort = NULL )
	{
		...
		$next_page=NULL;
		//算出總頁數
		if(isNotNull($page) && isNotNull($rows))
		{
	 ...
	 * 修改日期：2012/08/06
	 * 修改者：Hans*/	
	function listDB( $str_table_name ,$obj_field=NULL, $str_conditions = NULL , $int_rows = NULL , $int_page = NULL , $arr_sort = NULL, $arr_group = NULL )
	{
		$sql = " SELECT SQL_CALC_FOUND_ROWS ";
